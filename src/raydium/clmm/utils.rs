...
// ) -> Result<Option<u64>> {
//     let result = match (is_base_input, zero_for_one) {
//         (true, true) => liquidity_math::get_delta_amount_0_unsigned(
//             sqrt_price_target_x64,
//             sqrt_price_current_x64,
//             liquidity,
//             true,
//         ),
//         (true, false) => liquidity_math::get_delta_amount_1_unsigned(
//             sqrt_price_current_x64,
//             sqrt_price_target_x64,
//             liquidity,
//             true,
...
//         (false, true) => liquidity_math::get_delta_amount_1_unsigned(
//             sqrt_price_target_x64,
//             sqrt_price_current_x64,
//             liquidity,
//             false,
//         ),
//         (false, false) => liquidity_math::get_delta_amount_0_unsigned(
//             sqrt_price_current_x64,
//             sqrt_price_target_x64,
//             liquidity,
//             false,
...
//         Err(e) => {
//             if e.downcast_ref::<ErrorCode>()
//                 == Some(&ErrorCode::MaxTokenOverflow)
//             {
//                 Ok(None)
//             } else {
//                 Err(anyhow::anyhow!(ErrorCode::SqrtPriceLimitOverflow))
//             }
//         }
//     }
// }